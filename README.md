...
### Prerequisites
* **Python 3.10** or **3.11** (Required for TensorFlow 2.15 stability)
* **OS:** Windows, Linux, or macOS

### Step 1: Clone and Install
Navigate to the project directory and install the dependencies using the provided requirements file to ensure version compatibility.
